...
def main():
    ...
    model = ECAPA_TDNN_SMALL(feat_dim=256, emb_dim=256).to(device)
    model.load_state_dict(checkpoint['model_state_dict'])
    model.eval()
    print("Model loaded successfully")

    # Get all audio files
    folder_path = "./voice_cloning/speaker_encoder/data/test/sample"
    ...
    # Save embeddings
    output_path = "checkpoints/precomputed_embeddings_test.pt"
